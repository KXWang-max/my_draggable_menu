...
!function (t, e) {
	...
	var z, G, U, q, V, Z, Q, $, J, tt, et, nt, ot, it, rt, at, lt, st, ct, ut, dt, ht, ft, pt, gt, vt = !1, mt = !1,
		bt = [], yt = !1, wt = !1, Et = [], Dt = !1, _t = [], St = "undefined" != typeof document, Ct = n,
		Tt = E || w ? "cssFloat" : "float", xt = St && !i && !n && "draggable" in document.createElement("div"),
		Mt = function () {
			if (St) {
				if (w) return !1;
		...
		constructor: Rt, _isOutsideThisEl: function (t) {
			...
			if (rt) {
				var e = this.options, n = e.fallbackTolerance, o = e.fallbackOffset, i = t.touches ? t.touches[0] : t,
					r = U && v(U), a = U && r && r.a, l = U && r && r.d, s = Ct && gt && b(gt),
			...
			K("dragStart", this, {evt: t}), Rt.eventCanceled ? this._onDrop() : (K("setupClone", this), Rt.eventCanceled || ((Q = _(z)).draggable = !1, Q.style["will-change"] = "", this._hideClone(), k(Q, this.options.chosenClass, !1), Rt.clone = Q), n.cloneId = Ht(function () {
				...
				if (mt = !1, c && !e.disabled && (u ? d || (r = !q.contains(z)) : it === this || (this.lastPutMode = ot.checkPull(this, c, z, n)) && t.checkPut(this, c, z, n))) {
					...
					if (!g || function (t, e, n) {
						...
						var v, m, b, y = z.parentNode !== l, w = !function (t, e, n) {
							...
							D = Y(s, "top", "top") || Y(z, "top", "top"), _ = D ? D.scrollTop : void 0;
	...
	var jt, Kt, Wt, zt, Gt, Ut, qt = [], Vt = !(Rt.version = "1.10.1");
		...
		if (t.scroll) {
			...
			do {
				var f = h, p = X(f), g = p.top, v = p.bottom, m = p.left, b = p.right, y = p.width, w = p.height,
					E = void 0, D = void 0, _ = f.scrollWidth, S = f.scrollHeight, C = R(f), T = f.scrollLeft,
					x = f.scrollTop;
