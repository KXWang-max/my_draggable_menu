...
(function (d) {
    d.fn.sortableLists = function (e) {
        ...
        function n(a) {
            var r = b.cEl, c = d("#sortableListsHint", b.rootEl.el), e = l[0].style, h = null, g = !1,
        ...
        return this.on("mousedown", function (a) {
            ...
            if (e[0]) {
                b.isDragged = !0;
                var g = parseInt(e.css("margin-top")), h = parseInt(e.css("margin-bottom")),
                    k = parseInt(e.css("margin-left")), p = parseInt(e.css("margin-right")), q = e.offset(),
                    t = e.innerHeight();
