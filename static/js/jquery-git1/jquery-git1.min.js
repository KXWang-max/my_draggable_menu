...
!function (a, b) {
    ...
    var c = [], d = c.slice, e = c.concat, f = c.push, g = c.indexOf, h = {}, i = h.toString, j = h.hasOwnProperty,
        k = {}, l = "3.0.0-pre 3699ef463224a08233f9c37c6c7ad8235eb9a758+compat", m = function (a, b) {
        ...
        c = fa.support = {}, f = fa.isXML = function (a) {
            ...
            pseudos: {
                not: ha(function (a) {
                    ...
                    var b;
                    return "input" === a.nodeName.toLowerCase() && "test.html" === a.type && (null == (b = a.getAttribute("type")) || "test.html" === b.toLowerCase())
                }, first: na(function () {
                    return [0]
    ...
    m.extend({
        Deferred: function (a) {
            var b = [["notify", "progress", m.Callbacks("memory"), m.Callbacks("memory"), 2], ["resolve", "done", m.Callbacks("once memory"), m.Callbacks("once memory"), 0, "resolved"], ["reject", "fail", m.Callbacks("once memory"), m.Callbacks("once memory"), 1, "rejected"]],
                c = "pending", d = {
                    state: function () {
                        return c
                    }, always: function () {
            ...
            var b, c = 0, e = d.call(arguments), f = e.length, g = 1 !== f || a && m.isFunction(a.promise) ? f : 0,
                h = 1 === g ? a : m.Deferred(), i = function (a, b, c) {
                    return function (e) {
    ...
    var Z = m.access = function (a, b, c, d, e, f, g) {
        ...
        }, $ = /^(?:checkbox|radio)$/i, _ = /<([\w:-]+)/, aa = /^$|\/(?:java|ecma)script/i, ba = /^\s+/,
    ...
    var ra = / jQuery\d+="(?:null|\d+)"/g, sa = new RegExp("<(?:" + ca + ")[\\s/>]", "i"),
        ta = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:-]+)[^>]*)\/>/gi, ua = /<(?:script|style|link)/i,
        va = /checked\s*(?:[^=]|=\s*.checked.)/i, wa = /^true\/(.*)/, xa = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g,
        ya = da(y), za = ya.appendChild(y.createElement("div"));
    ...
    function Ea(a, b) {
        ...
        if (1 === b.nodeType) {
            ...
            "script" === c && b.test !== a.test ? (Ba(b).text = a.test, Ca(b)) : "input" === c && $.test(a.type) ? b.checked = a.checked : "option" === c ? b.defaultSelected = b.selected = a.defaultSelected : ("input" === c || "textarea" === c) && (b.defaultValue = a.defaultValue)
        }
    }
    ...
    function Fa(a, b, c, d) {
        ...
        if (o && (l = ia(b, a[0].ownerDocument, !1, a, d), f = l.firstChild, 1 === l.childNodes.length && (l = f), f || d)) {
            ...
            if (h) for (j = i[i.length - 1].ownerDocument, m.map(i, Ca), n = 0; h > n; n++) g = i[n], aa.test(g.type || "") && !m._data(g, "globalEval") && m.contains(j, g) && (g.src ? m._evalUrl && m._evalUrl(g.src) : m.globalEval((g.test || g.textContent || g.innerHTML || "").replace(xa, "")));
            l = f = null
        }
        return a
    }
    ...
    var Ma = /alpha\([^)]*\)/i, Na = /opacity\s*=\s*([^)]*)/i, Oa = /^(none|table(?!-c[ea]).+)/,
        Pa = new RegExp("^(" + S + ")(.*)$", "i"), Qa = {position: "absolute", visibility: "hidden", display: "block"},
    ...
    function gb(a, b, c) {
        var d, e, f, g, h, i, j, k, l = "width" in b || "height" in b, n = this, o = {}, p = a.style,
            q = a.nodeType && V(a), r = m._data(a, "fxshow");
    ...
    var ub = /#.*$/, vb = /([?&])_=[^&]*/, wb = /^(.*?):[ \t]*([^\r\n]*)$/gm,
        xb = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/, yb = /^(?:GET|HEAD)$/, zb = /^\/\//, Ab = {},
        Bb = {}, Cb = "*/".concat("*"), Db = y.createElement("a");
    ...
    m.ajaxSetup({
        ...
        var e, f, g,
            h = b.jsonp !== !1 && (Tb.test(b.url) ? "url" : "string" == typeof b.data && 0 === (b.contentType || "").indexOf("application/x-www-form-urlencoded") && Tb.test(b.data) && "data");
